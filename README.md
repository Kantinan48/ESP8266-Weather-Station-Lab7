...
โปรเจกต์สถานีวัดอากาศอัจฉริยะด้วย **ESP8266 (NodeMCU)** แสดงผลข้อมูลแบบ Real-time บน **Blynk 2.0 Web Dashboard** โดยรับค่าจากเซนเซอร์ 3 ชนิด เพื่อตรวจจับอุณหภูมิ ความชื้น ดัชนีความร้อน (Feel Like) สถานะแสงกลางวัน/กลางคืน และสถานะฝนตก
